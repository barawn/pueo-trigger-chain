...
\begin{figure}
    ...
    \end{center}
    \caption{\label{fig:efficiency_beamformer} PUEO Trigger efficiency.
    Lorem Ipsum
    }
\end{figure}
...
for two adjacent SURFs, feeding signals into PUEO's full RF chain and into the DAQ. The 
RF box is set to simulate a signal arriving from a direction visible to the beams of both 
of the SURFs under test. 
...
Talk about 6$\rightarrow$8 antenna scaling
Talk about SNR calculation
Talk about windowing
