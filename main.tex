...
mitigate this, up to 2 programmable digital biquad filters were implemented in the CW
...
The data out of the signal processing chain was then formed into
48 total virtual antenna beams. These beams were processed to form
a signal envelope and then thresholded to form the trigger.

The 48 total beams consist of 35 8-channel beams spanning from 
$\sim0^\circ$ to $\sim-17^\circ$ in zenith and 13 6-channel beams 
centered at $4^{\circ}$ and $-20^{\circ}$ in zenith, both
roughly spanning $\pm30^{\circ}$ in azimuth. The 6 channel beams
utilized only the lower antennas, allowing the less signal-rich
...
threshold, a bit in the metadata is set.
...
The SURF firmware was designed to allow the trigger portion of the
firmware to be activated after initialization, which also allows for
direct power measurements for the active portion of the trigger. At
