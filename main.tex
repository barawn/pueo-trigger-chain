...
a final collection of 42 total beams. An additional 6 beams are
also formed using only the left and right sub-beams - without the
large baseline from the top antennas, these beams are therefore
significantly wider in zenith angle acceptance and act to cover signals
outside of the other beams with fewer trials.
