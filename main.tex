...
in multiple (48 implemented) beamformed directions at once. In addition,
significant pre-trigger signal processing is used to enhance the overall
signal-to-noise ratio (SNR) prior to the beamform process.
