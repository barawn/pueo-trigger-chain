...
\pgfdeclareshape{dspshapebandstop}{
	...
	\foregroundpath{
		...
		\pgfpathlineto{\pgfpoint{-0.33\pgf@xa} {0.33\pgf@ya}}
		%lowpass
        \pgfpathmoveto{\pgfpoint{0.25\pgf@xa} {-0.33\pgf@ya}}
		\pgfpathlineto{\pgfpoint{0.15\pgf@xa} {-0.33\pgf@ya}}
        \pgfpathlineto{\pgfpoint{0.1\pgf@xa} {0.2\pgf@ya}}
        \pgfpathlineto{\pgfpoint{-0.1\pgf@xa} {0.2\pgf@ya}}
		\pgfpathlineto{\pgfpoint{-0.15\pgf@xa} {-0.33\pgf@ya}}
        \pgfpathlineto{\pgfpoint{-0.25\pgf@xa} {-0.33\pgf@ya}}
	}
}
...
\tikzset{dspbandstop/.style=
	{
		draw,
		shape=dspshapebandstop,
		line width=\dspblocklinewidth,
		minimum size=\dspsquareblocksize
	}
}
